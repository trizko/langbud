...
from models.message import Message, create_message
from models.explanation import Explanation, create_explanation, get_explanation_by_message
...
async def test_get_explanation_by_message(db_pool):
    async with db_pool.acquire() as connection:
        ...
        explanation = await create_explanation(connection, message, "test_get_explanation_by_message")
